...
public class ArmoredSkele extends MovingEntity {

    private Sensor sensor;
    private boolean frozenByWall = false;

    public ArmoredSkele(double x, double y, SpriteLibrary sprites) {
        super(x, y, 1, sprites);
        ...
        animations.put("armoredSkeleAnim", new Animate(sprites.get("armoredSkeleAnim"), 8));
        currentAnimation = animations.get("armoredSkeleAnim");
    }
