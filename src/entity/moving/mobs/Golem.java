...
public class Golem extends MovingEntity {
    ...
    public Golem(double x, double y, SpriteLibrary sprites) {
        super(x, y, 1, sprites);
        ...
        animations.put("golemAnim", new Animate(sprites.get("golemAnim"), 8));
        currentAnimation = animations.get("golemAnim");
    }
    @Override
