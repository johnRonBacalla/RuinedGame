...
public class MagmaBomber extends MovingEntity {

    private Sensor sensor;
    private boolean frozenByWall = false;

    public MagmaBomber(double x, double y, SpriteLibrary sprites) {
        super(x, y, 1, sprites);
        ...
        animations.put("magmaBomberAnim", new Animate(sprites.get("magmaBomberAnim"), 8));
        currentAnimation = animations.get("magmaBomberAnim");
    }
