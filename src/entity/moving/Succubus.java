...
public class Succubus extends MovingEntity{
    public Succubus(double x, double y, SpriteLibrary sprites) {
        super(x, y, 1, sprites);
        ...
        animations.put("succubusAnim", new Animate(sprites.get("succubusAnim"), 8));
        currentAnimation = animations.get("succubusAnim");
    }
