...
public class Ogre extends MovingEntity{
    public Ogre(double x, double y, SpriteLibrary sprites) {
        super(x, y, 1, sprites);
        ...
        animations.put("ogreAnim", new Animate(sprites.get("ogreAnim"), 8));
        currentAnimation = animations.get("ogreAnim");
    }
