...
public class Bat extends MovingEntity{
    public Bat(double x, double y, SpriteLibrary sprites) {
        super(x, y, 1, sprites);
        ...
        animations.put("batAnim", new Animate(sprites.get("batAnim"), 8));
        currentAnimation = animations.get("batAnim");
    }
